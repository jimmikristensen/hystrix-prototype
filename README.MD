...
Try accessing it through __Postman__ or curl:
...
Access the hystrix dashboard [http://localhost:8081/hystrix](http://localhost:8081/hystrix)

http://192.168.1.14:8080/HystrixPrototype/hystrix.stream
